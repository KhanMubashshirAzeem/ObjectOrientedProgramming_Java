...
#### 2. Encapsulation
- **Encapsulation**: Ensures that "sensitive" data is hidden from users. It’s implemented by declaring class variables as private and providing public getter and setter methods. This helps maintain control over the data and reduces the risk of unintended interference.
